...
{
    public class UnitTestFibonacciWithRecursionAdvance
    {
        [Test]
        [TestCase(-1)]
        [TestCase(93)]
        ...
        {
            Assert.Throws<ArgumentException>(() => { Fibonacci.FibonacciWithRecursion(-5); });
        }
        ...
        {
            Assert.AreEqual(result, Fibonacci.FibonacciWithRecursion(n));
        }
    }
}